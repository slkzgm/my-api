...
const initializeClient = async () => {
  ...
  [dnaChannels.human, dnaChannels.robot, dnaChannels.demon, dnaChannels.angel, dnaChannels.reptile, dnaChannels.undead,
    dnaChannels.murakami, dnaChannels.alien, dnaChannels.drip] = await Promise.all([
    getChannelById('1115678110067732651'),
    getChannelById('1115678120511549440'),
    getChannelById('1115678139704692766'),
    getChannelById('1115678155986972742'),
    getChannelById('1115678166606954506'),
    getChannelById('1115678185066090587'),
    getChannelById('1115678199561584640'),
    getChannelById('1115678209674051687'),
    getChannelById('1166403864690442320')
  ]);
...
const createSaleEmbedMsg = (details) => {
  return new EmbedBuilder()
      ...
      .addFields({ name: 'Eggs', value: details.claimed ? ':x:' : ':egg:'},
          { name: 'DNA', value: details.dna.toUpperCase(), inline: true },
          { name: 'DRIP', value: details.drip ? ':cherry_blossom:' : ':x:'}
      )
      .addFields(
